package com.lineupkita.app.ui.detail
...
@AndroidEntryPoint
class DetailfestivalFragment : Fragment(R.layout.fragment_detail_festival) {

    private val binding by viewBinding<FragmentDetailFestivalBinding>()
...
//        parentNavigation?.isVisible = false
    ...
    private fun initView(){
        ...
        binding.rvLineup.adapter = lineupAdapter
